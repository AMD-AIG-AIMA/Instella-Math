...
def exaone_dtensor_weight_loader(actor_weights: Dict, vllm_model: nn.Module) -> nn.Module:
        stacked_params_mapping = [
            # (param_name, shard_name, shard_id)
            (".qkv_proj", ".q_proj", "q"),
            (".qkv_proj", ".k_proj", "k"),
...
__MODEL_DTENSOR_WEIGHT_LOADER_REGISTRY__ = {
    ...
    "InstellaForCausalLM": llama_dtensor_weight_loader,
    "ExaoneForCausalLM": exaone_dtensor_weight_loader,
}
