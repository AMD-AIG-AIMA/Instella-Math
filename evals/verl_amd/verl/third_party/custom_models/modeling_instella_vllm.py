...
class InstellaDecoderLayer(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        # assert isinstance(config, InstellaConfig)
        # Attention block.
        self.self_attn = InstellaAttention(vllm_config=vllm_config,
...
class InstellaModel(nn.Module):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: InstellaDecoderLayer(vllm_config=vllm_config,
                                             prefix=prefix),
...
class InstellaForCausalLM(nn.Module, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        # assert isinstance(config, InstellaConfig)
        self.config = config
        self.model = InstellaModel(vllm_config=vllm_config,
