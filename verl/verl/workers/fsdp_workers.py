...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(
        ...
        print("#############################MODEL PATH IS: ", local_path)
        ...
        self.generation_config = get_generation_config(local_path, trust_remote_code=True)
    ...
    def init_model(self):
        ...
        if self._is_rollout:
            self.rollout, self.rollout_sharding_manager = self._build_rollout(trust_remote_code=self.config.model.get("trust_remote_code", True))
